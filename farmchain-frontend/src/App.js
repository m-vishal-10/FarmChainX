...
function App() {
  // Load role from localStorage on refresh
  ...
  const router = createBrowserRouter([
    ...
    },
    {
      path: "/farmer",
      element: (
        <FarmerDashboard userRole={userRole} setUserRole={setUserRole} />
      ),
    },
    {
      path: "/distributor",
      element: (
        <DistributorDashboard userRole={userRole} setUserRole={setUserRole} />
      ),
    },
    {
      path: "/retailer",
      element: (
        <RetailerDashboard userRole={userRole} setUserRole={setUserRole} />
      ),
    },
    {
      path: "/consumer",
      element: (
        <ConsumerDashboard userRole={userRole} setUserRole={setUserRole} />
      ),
    },
    {
      path: "/admin",
